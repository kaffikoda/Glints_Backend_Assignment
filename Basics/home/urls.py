...
urlpatterns = [
    ...
    re_path(r'^show_top_restaurants/top=([0-9]+)/greater_than=([0-9]+)/price_range=([0-9]+(\.[0-9]{1,2}))-([0-9]+(\.[0-9]{1,2}))', v1.show_top_restaurants1, name='show_restaurants'),
    re_path(r'^show_top_restaurants/top=([0-9]+)/lesser_than=([0-9]+)/price_range=([0-9]+(\.[0-9]{1,2}))-([0-9]+(\.[0-9]{1,2}))', v1.show_top_restaurants2, name='show_restaurants')
]
